              ...
              (function (i, val) {
                  ...
                  p.hover(function () {
                      ...
                      if (title == "Money") {
                        ...
                        subRev.attr('text',  "of the TZS."+Math.round(daily)+" you earned today.");
                        subTime.attr('text', "");
                        ...
                        subRev.attr('text', "took around TZS."+formatDollar(data[i].value)+" or about 10%");
                        subTime.attr('text', "of that as income tax, depending on your state.");
                          ...
                          subRev.attr('text', "received TZS."+formatDollar(data[i].value)+" of that TZS."+formatDollar(amount));
    ...
    this.showInfo = function (which, amount) {
        ...
        face.push(
         paper.circle(cx+2, cy+2, rad-wheight/25).attr({fill:"#dedddb", stroke: "none", "stroke-width": 4}),
          ...
          paper.text(cx, (cy-(rad-(fontSizer*9))), "for a contribution of TZS."+formatDollar(amount)).attr({"font-family": "Crimson Text", 'font-size': (fontSizer)+"px"}),
    ...
    this.showMoney = function (amount) {
        ...
        face.push(
         paper.circle(cx+2, cy+2, rad-wheight/25).attr({fill:"#dedddb", stroke: "none", "stroke-width": 4}),
          ...
          paper.text(cx, (cy-(rad-(fontSizer*7.5))), "TZS."+formatDollar(amount)+" and paid "+(100-Math.round(amount/salary * 100))+" %").attr({"font-family": "Crimson Text", 'font-size': (fontSizer+6)+"px", "font-style":"italic"}),
          paper.text(cx, (cy-(rad-(fontSizer*9))), "of your salary of TZS."+formatDollar(salary)+" towards taxes.").attr({"font-family": "Crimson Text", 'font-size': (fontSizer)+"px"}),
