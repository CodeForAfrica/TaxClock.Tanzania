Raphael.fn.clock = function (cx, cy, rad) {
  ...
  this.rollBack = function (years) {
    ...
    if(salary < 100000){
      ...
      thesalary.attr('text', "TZS."+formatDollar(salary));
    }
    ...
    chart.push( 
      ...
      thesalary = paper.text(cx, (cy-(rad-(fontSizer*9))), "TZS."+formatDollar(salary)).attr({"font-family": "Poppins", 'font-size':  (fontSizer+6)+"px", fill:"#fff"}),
